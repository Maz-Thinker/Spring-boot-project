...
@RestController @RequestMapping("/inventory") public class InventoryController {
    ...
    @PutMapping public Map<String, String> updateInventory(@RequestBody CombinedRequest request) {
        ...
        if (!serviceClass.ValidateProductId(product.getId())) {
            map.put("message", "Id " + product.getId() + " not present in database"); return map;
        }
        ...
        if (inventory != null) {
            try {
                ...
                map.put("message", "Error: " + e); System.out.println(e); return map;
            } }
